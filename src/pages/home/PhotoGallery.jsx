const PhotoGallery = () => {
	return (
		<div className='container my-36'>
			...
			<div className='max-w-full grid grid-cols-2 md:grid-cols-4 gap-3  grid-flow-dense'>
				<figure data-aos='zoom-in' className=''>
					<img
				...
				<figure data-aos='zoom-out' className='row-span-2'>
					<img
						className='h-full w-full object-fill rounded-md'
				...
				<figure data-aos='zoom-in' className='col-span-2'>
					<img
						className='h-full w-full object-fill rounded-md'
...
'
				...
				<figure data-aos='zoom-out' className=''>
					<img
						className='h-full w-full object-fill rounded-md'
